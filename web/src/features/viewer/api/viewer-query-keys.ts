export const viewerKeys = {
	...
	mutations: {
		...
		adminUpdateStorageClassMetadata: () => [...viewerKeys.all, 'mutation', 'admin-update-storage-class-metadata'] as const,
		...
		updatePVC: () => [...viewerKeys.all, 'mutation', 'update-pvc'] as const,
	...
	pvcDescribe: (namespace: string, name: string) => [...viewerKeys.all, 'pvcs', namespace, name, 'describe'] as const,
	pvcYAML: (namespace: string, name: string) => [...viewerKeys.all, 'pvcs', namespace, name, 'yaml'] as const,
